...
export function Sidebar() {
  ...
  return (
    <aside className="sticky top-0 flex h-screen w-72 shrink-0 border-r border-white/8 bg-deck-950/54 p-3 backdrop-blur-2xl">
      <div className="flex w-full flex-col rounded-[1.7rem] border border-white/9 bg-[linear-gradient(180deg,rgba(19,18,43,0.78),rgba(7,7,17,0.58))] px-3 py-3 shadow-[0_26px_80px_rgba(0,0,0,0.28),inset_0_1px_0_rgba(255,255,255,0.07)]">
      <Link href="/dashboard" className="mb-7 flex items-center gap-3 rounded-2xl p-2 transition hover:bg-white/5">
        ...
        {navItems.map((item) => {
          ...
          return (
            <Link
              ...
              href={item.href}
              className={clsx(
                "group flex h-11 items-center gap-3 rounded-2xl px-3 text-sm font-medium transition duration-200",
                active
      ...
      <div className="mt-auto rounded-2xl border border-white/10 bg-white/6 p-4 text-xs leading-5 text-white/58 shadow-[inset_0_1px_0_rgba(255,255,255,0.06)]">
